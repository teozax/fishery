...
#ifndef _Duplicate269_HH_
#define _Duplicate269_HH_
...
struct Duplicate269 : public sc_module {
    ...
    // Module declarations
    Duplicate269(sc_module_name name);
    SC_HAS_PROCESS(Duplicate269);
    ...
    sc_signal< sc_lv<32> > t_V_9_reg_107;
