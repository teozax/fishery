...
// ==============================================================
#ifndef __net_holes_detectidtH__HH__
#define __net_holes_detectidtH__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(net_holes_detectidtH) {
    ...
    SC_CTOR(net_holes_detectidtH):  ACMP_smul_us_U ("ACMP_smul_us_U") {
