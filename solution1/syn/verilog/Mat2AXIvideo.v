...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln126_reg_234 == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln126_reg_234_pp0_iter1_reg == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end
...
assign axi_last_V_fu_192_p2 = ((t_V_6_reg_152 == 9'd479) ? 1'b1 : 1'b0);

assign i_V_fu_174_p2 = (t_V_reg_141 + 9'd1);

assign icmp_ln125_fu_168_p2 = ((t_V_reg_141 == 9'd270) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_180_p2 = ((t_V_6_reg_152 == 9'd480) ? 1'b1 : 1'b0);

assign j_V_fu_186_p2 = (t_V_6_reg_152 + 9'd1);
