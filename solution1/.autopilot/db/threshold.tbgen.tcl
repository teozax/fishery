...
set C_modelArgList {
	...
	{ Luminance_img_V_V int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "IN_data_stream_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "Luminance_img_V_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ Luminance_img_V_V_din sc_out sc_lv 32 signal 1 } 
	{ Luminance_img_V_V_full_n sc_in sc_logic 1 signal 1 } 
	{ Luminance_img_V_V_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Luminance_img_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Luminance_img_V_V", "role": "din" }} , 
 	{ "name": "Luminance_img_V_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Luminance_img_V_V", "role": "full_n" }} , 
 	{ "name": "Luminance_img_V_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Luminance_img_V_V", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "Luminance_img_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	Luminance_img_V_V { ap_fifo {  { Luminance_img_V_V_din fifo_data 1 32 }  { Luminance_img_V_V_full_n fifo_status 0 1 }  { Luminance_img_V_V_write fifo_update 1 1 } } }
}
