...
set C_modelArgList {
	{ src1_data_stream_V int 16 regular {fifo 0 volatile }  }
	{ src2_data_stream_V int 16 regular {fifo 0 volatile }  }
	{ dst_rows_V int 10 regular {fifo 0}  }
	{ dst_cols_V int 10 regular {fifo 0}  }
	{ dst_data_stream_V int 16 regular {fifo 1 volatile }  }
	{ dst_rows_V_out int 10 regular {fifo 1}  }
	{ dst_cols_V_out int 10 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src1_data_stream_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "src2_data_stream_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "dst_rows_V", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "dst_cols_V", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_cols_V_out", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "src1_data_stream_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "src1_data_stream_V", "role": "dout" }} , 
 	...
 	{ "name": "src2_data_stream_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "src2_data_stream_V", "role": "dout" }} , 
 	...
 	{ "name": "dst_cols_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "dst_cols_V", "role": "dout" }} , 
 	...
 	{ "name": "dst_cols_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "dst_cols_V_out", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "130411"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "130411"}
]}
...
set Spec2ImplPortList { 
	src1_data_stream_V { ap_fifo {  { src1_data_stream_V_dout fifo_data 0 16 }  { src1_data_stream_V_empty_n fifo_status 0 1 }  { src1_data_stream_V_read fifo_update 1 1 } } }
	src2_data_stream_V { ap_fifo {  { src2_data_stream_V_dout fifo_data 0 16 }  { src2_data_stream_V_empty_n fifo_status 0 1 }  { src2_data_stream_V_read fifo_update 1 1 } } }
	dst_rows_V { ap_fifo {  { dst_rows_V_dout fifo_data 0 10 }  { dst_rows_V_empty_n fifo_status 0 1 }  { dst_rows_V_read fifo_update 1 1 } } }
	dst_cols_V { ap_fifo {  { dst_cols_V_dout fifo_data 0 10 }  { dst_cols_V_empty_n fifo_status 0 1 }  { dst_cols_V_read fifo_update 1 1 } } }
	...
	dst_cols_V_out { ap_fifo {  { dst_cols_V_out_din fifo_data 1 10 }  { dst_cols_V_out_full_n fifo_status 0 1 }  { dst_cols_V_out_write fifo_update 1 1 } } }
}
